...
if("TRUE" STREQUAL "TRUE")
  set(turtlebot3_gazebo_SOURCE_PREFIX /home/nichotelo/ros/turtlebot3/src/turtlebot3_simulations/turtlebot3_gazebo)
  set(turtlebot3_gazebo_DEVEL_PREFIX /home/nichotelo/ros/turtlebot3/devel)
  ...
  set(turtlebot3_gazebo_INSTALL_PREFIX /home/nichotelo/ros/turtlebot3/install)
...
if(NOT "/home/nichotelo/ros/turtlebot3/src/turtlebot3_simulations/turtlebot3_gazebo/include " STREQUAL " ")
  set(turtlebot3_gazebo_INCLUDE_DIRS "")
  set(_include_dirs "/home/nichotelo/ros/turtlebot3/src/turtlebot3_simulations/turtlebot3_gazebo/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'turtlebot3_gazebo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nichotelo/ros/turtlebot3/src/turtlebot3_simulations/turtlebot3_gazebo/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/nichotelo/ros/turtlebot3/devel/lib;/home/nichotelo/ros/turtlebot3/devel/lib;/home/nichotelo/ros/2wd_robot/devel/lib;/home/nichotelo/catkin_ws/devel/lib;/opt/ros/noetic/lib)
